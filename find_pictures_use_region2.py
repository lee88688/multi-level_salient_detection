...
cache_out_dir = r'G:\Project\paper2\cache\cache_msra_600\feature_cache'
...
if __name__ == "__main__":
    freeze_support()
    start = time()
    pic_list = ['2_86_86610.npy', '3_116_116365.npy', '4_126_126766.npy', '1_56_56155.npy', '2_91_91853.npy'] # max score is: 0.814133716039, c=10
    pic_list = ['4_133_133219.npy', '0_3_3524.npy', '1_58_58837.npy']  # 0.805325206825, c=1
    pic_list = ['323016.npy', '181079.npy', '35010.npy']  # 0.516207737888 on sod
    pic_list = ['1_26_26213.npy', '2_68_68401.npy', '0_9_9353.npy']  # 0.812216623508 
    pic_list = map(lambda s: s.split('.')[0] + '.jpg', pic_list);
    # feature, label = get_features(original_img_dir, binary_img_dir, pic_list=pic_list)
    # clf = train_features(feature, label > 0.9, C=10)

    # img = io.imread(r'G:\Project\paper2\images\(1).jpg')
    # features, segments = extract_features(img)
    # io.imshow(feature_to_image(features[:, -1], segments))
    # io.show()
    # io.imshow(feature_to_image(features[:, -2], segments))
    # io.show()

    # original_img_dir = r'G:\Project\paper2\other_image\SODandSED\SOD_IMAGE\src'
    # binary_img_dir = r'G:\Project\paper2\other_image\SODandSED\SOD_IMAGE\SOD_gt2'
    # cache_out_dir = r'G:\Project\paper2\cache_sed1\feature_cache'
    # save_features(original_img_dir, binary_img_dir, cache_out_dir)
    # print_all_score(cache_out_dir, C=1, iter=iter)
    # product_saliency_image_use_cache(original_img_dir, binary_img_dir, cache_out_dir, pic_list, 10, "msra")
    # product_saliency_image(original_img_dir, binary_img_dir, pic_list, 10, "withft")
    print_max_score(cache_out_dir, 10000, 3, C=1)
